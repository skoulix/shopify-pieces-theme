import{g as c,S as m,a as v,F as $}from"./pieces-gsap.js";import{L as I}from"./pieces-lenis.js";import{_ as O,s as N,i as R,l as z,o as B,r as U}from"./pieces-swup.js";c.registerPlugin(m);class j{constructor(){this.lenis=null,this.isInitialized=!1}init(){return this.isInitialized?this.lenis:(this.lenis=new I({duration:1.2,easing:t=>Math.min(1,1.001-Math.pow(2,-10*t)),orientation:"vertical",gestureOrientation:"vertical",smoothWheel:!0,wheelMultiplier:1,touchMultiplier:2,infinite:!1,prevent:t=>t.closest(".cart-drawer__content")||t.closest(".mobile-nav__content")||t.closest("[data-lenis-prevent]")}),this.lenis.on("scroll",m.update),c.ticker.add(t=>{this.lenis.raf(t*1e3)}),c.ticker.lagSmoothing(0),document.documentElement.classList.add("lenis"),this.isInitialized=!0,this.lenis)}scrollTo(t,e={}){if(!this.lenis)return;const i={offset:0,duration:1.2,easing:n=>Math.min(1,1.001-Math.pow(2,-10*n)),immediate:!1,lock:!1,onComplete:null};this.lenis.scrollTo(t,{...i,...e})}stop(){this.lenis&&this.lenis.stop()}start(){this.lenis&&this.lenis.start()}resize(){this.lenis&&this.lenis.resize()}destroy(){this.lenis&&(this.lenis.destroy(),this.lenis=null,this.isInitialized=!1,document.documentElement.classList.remove("lenis"))}get scroll(){return this.lenis?.scroll||0}get progress(){return this.lenis?.progress||0}get isScrolling(){return this.lenis?.isScrolling||!1}}const w=new j;c.registerPlugin(m);class V{constructor(){this.swup=null,this.isInitialized=!1,this.pageTransitionDuration=.6,this.skipAnimation=!1,this.transitionStyle=window.themeSettings?.pageTransitionStyle||"slide",this.supportsViewTransitions=typeof document.startViewTransition=="function"}shouldUseViewTransitions(){return this.supportsViewTransitions&&window.themeSettings?.enableViewTransitions!==!1&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches}init(){if(this.isInitialized)return this.swup;if(window.Shopify&&window.Shopify.designMode)return null;window.addEventListener("error",e=>{if(e.message&&e.message.includes("Cannot assign to read only property 'protect'"))return e.preventDefault(),!0}),this.shouldUseViewTransitions()&&this.injectViewTransitionStyles();const t=[{from:"(.*)",to:"(.*)",out:async e=>{await this.animateOut(),e()},in:async e=>{await this.animateIn(),e()}}];return this.swup=new O({containers:["#swup-container"],cache:!0,animateHistoryBrowsing:!0,linkSelector:'a[href^="'+window.location.origin+'"]:not([data-no-swup]), a[href^="/"]:not([data-no-swup]):not([href^="//"]), a[href^="#"]:not([data-no-swup])',plugins:[new N(t),new R({persistAssets:!0,persistTags:'link[rel="stylesheet"], style, script[src]'}),new z({preloadVisibleLinks:!0}),new B,new U({head:!1,body:!0})]}),this.setupEventListeners(),this.isInitialized=!0,this.swup}setupEventListeners(){this.swup.hooks.on("visit:start",t=>{document.documentElement.classList.add("is-changing"),document.documentElement.classList.add("scroll-locked"),w.stop(),t.to.url.includes("/cart")&&this.swup.cache.delete(t.to.url)}),this.swup.hooks.on("content:replace",()=>{m.getAll().forEach(e=>e.kill()),this.reinitializeComponents();const t=document.querySelector("main");t&&(t.setAttribute("tabindex","-1"),t.focus({preventScroll:!0}),this.announcePageChange()),requestAnimationFrame(()=>{w.resize(),m.refresh()})}),this.swup.hooks.on("visit:end",()=>{document.documentElement.classList.remove("is-changing"),document.documentElement.classList.remove("scroll-locked"),w.start(),window.dispatchEvent(new CustomEvent("swup:transitionEnd"))}),this.swup.hooks.on("page:view",()=>{window.dispatchEvent(new CustomEvent("swup:pageview",{detail:{url:window.location.href}}))})}async animateOut(){if(this.skipAnimation||this.shouldUseViewTransitions()&&this._viewTransitionActive)return Promise.resolve();const t=document.querySelector("#swup-container"),e=document.querySelector(".page-transition-overlay"),i=c.timeline();switch(this.transitionStyle){case"fade":i.to(t,{opacity:0,duration:.4,ease:"power2.inOut"});break;case"slide":i.to(t,{y:-40,opacity:0,duration:.25,ease:"power2.in"});break;case"curtain":default:e&&(c.set(e,{transformOrigin:"bottom",scaleY:0}),i.to(e,{scaleY:1,duration:.4,ease:"power3.inOut"})),i.to(t,{y:-40,opacity:0,duration:.25,ease:"power2.in"},.1);break}return i}async animateIn(){w.scrollTo(0,{immediate:!0});const t=document.querySelector("#swup-container"),e=document.querySelector(".page-transition-overlay");if(this.skipAnimation)return this.skipAnimation=!1,c.set(t,{opacity:1,y:0,x:0}),e&&c.set(e,{scaleY:0,scaleX:0}),Promise.resolve();const i=c.timeline();switch(this.transitionStyle){case"fade":c.set(t,{opacity:0,x:0,y:0}),i.to(t,{opacity:1,duration:.4,ease:"power2.inOut"}),i.add(()=>{this.animateRevealElements()},.1);break;case"slide":c.set(t,{opacity:0,y:40,x:0}),i.to(t,{y:0,opacity:1,duration:.3,ease:"power2.out"}),i.add(()=>{this.animateRevealElements()},.1);break;case"curtain":default:c.set(t,{opacity:0,x:0,y:40}),e&&(c.set(e,{transformOrigin:"top",scaleY:1}),i.to(e,{scaleY:0,duration:.5,ease:"power3.inOut"})),i.to(t,{y:0,opacity:1,duration:.3,ease:"power2.out"},.2),i.add(()=>{this.animateRevealElements()},.3);break}return i}animateRevealElements(){document.querySelectorAll("[data-reveal]").forEach((e,i)=>{const n=e.dataset.revealDelay||i*.1;e.dataset.reveal,c.to(e,{opacity:1,x:0,y:0,scale:1,clipPath:"inset(0 0% 0 0)",duration:.8,delay:n,ease:"power2.out"})})}announcePageChange(){let t=document.getElementById("swup-announce");t||(t=document.createElement("div"),t.id="swup-announce",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sr-only",document.body.appendChild(t));const e=document.title||"Page loaded";t.textContent="",setTimeout(()=>{t.textContent=e},100)}reinitializeComponents(){window.dispatchEvent(new CustomEvent("swup:contentReplaced")),window.Shopify&&window.Shopify.PaymentButton&&window.Shopify.PaymentButton.init(),document.querySelectorAll("details-disclosure, details-modal").forEach(t=>{t.connectedCallback&&t.connectedCallback()})}navigateTo(t,e=!1){this.swup?(this.skipAnimation=e,this.swup.navigate(t)):window.location.href=t}updateUrl(t,e=!1){e?window.history.replaceState({swupPreview:!0},"",t):window.history.pushState({swupPreview:!0},"",t)}goBack(){window.history.back()}clearCache(t){if(!this.swup||!this.swup.cache)return;const e=Array.isArray(t)?t:[t];this.swup.cache.all.forEach((i,n)=>{e.some(s=>n.includes(s))&&this.swup.cache.delete(n)})}clearAllCache(){this.swup&&this.swup.cache&&this.swup.cache.clear()}injectViewTransitionStyles(){if(document.getElementById("view-transition-styles"))return;const t=document.createElement("style");t.id="view-transition-styles",t.textContent=`
    ...
    `,document.head.appendChild(t)}async startViewTransition(t){if(!this.shouldUseViewTransitions())return await t(),null;this._viewTransitionActive=!0;try{await document.startViewTransition(async()=>{await t()}).finished}catch{await t()}finally{this._viewTransitionActive=!1}}destroy(){this.swup&&(this.swup.destroy(),this.swup=null,this.isInitialized=!1)}}const P=new V;c.registerPlugin(m,v);class W{constructor(){this.animations=[],this.scrollTriggers=[],this.introObserver=null}getScrollTriggerStart(t="top 85%"){const e=window.themeSettings?.animationTriggerOffset||"md",i={none:t,sm:"top 90%",md:"top 80%",lg:"top 70%"};return i[e]||i.md}initRevealAnimations(){this.killScrollTriggers();const t=document.querySelectorAll("[data-reveal]"),e=this.getScrollTriggerStart();t.forEach(i=>{const n=i.dataset.reveal||"fade-up",s=parseFloat(i.dataset.revealDelay)||0,r=parseFloat(i.dataset.revealDuration)||.8,a=i.dataset.revealStart||e,o=this.getInitialState(n);c.set(i,o);const l=m.create({trigger:i,start:a,once:!0,onEnter:()=>{c.to(i,{opacity:1,x:0,y:0,scale:1,clipPath:"inset(0 0% 0 0)",duration:r,delay:s,ease:"power2.out"})}});this.scrollTriggers.push(l)})}getInitialState(t){const e={fade:{opacity:0},"fade-up":{opacity:0,y:40},"fade-down":{opacity:0,y:-40},"fade-left":{opacity:0,x:40},"fade-right":{opacity:0,x:-40},scale:{opacity:0,scale:.9},clip:{clipPath:"inset(0 100% 0 0)"},"clip-up":{clipPath:"inset(100% 0 0 0)"}};return e[t]||e.fade}initStaggerAnimations(){const t=document.querySelectorAll("[data-stagger]"),e=this.getScrollTriggerStart();t.forEach(i=>{const n=i.children,s=parseFloat(i.dataset.stagger)||.1,r=i.dataset.staggerStart||e;c.set(n,{opacity:0,y:20});const a=m.create({trigger:i,start:r,once:!0,onEnter:()=>{c.to(n,{opacity:1,y:0,duration:.6,stagger:s,ease:"power2.out"})}});this.scrollTriggers.push(a)})}initParallax(){document.querySelectorAll("[data-parallax]").forEach(e=>{const i=parseFloat(e.dataset.parallax)||.5,n=m.create({trigger:e,start:"top bottom",end:"bottom top",scrub:!0,onUpdate:s=>{const r=s.progress*100*i-50*i;c.set(e,{y:r})}});this.scrollTriggers.push(n)})}initImageReveals(){const t=document.querySelectorAll("[data-image-reveal]"),e=this.getScrollTriggerStart();t.forEach(i=>{const n=i.querySelector("img");if(!n)return;c.set(n,{scale:1.2,opacity:0});const s=m.create({trigger:i,start:e,once:!0,onEnter:()=>{c.to(n,{scale:1,opacity:1,duration:1.2,ease:"power2.out"})}});this.scrollTriggers.push(s)})}getAnimationRootMargin(){const t=window.themeSettings?.animationTriggerOffset||"md",e={none:"0px 0px 0px 0px",sm:"0px 0px -10% 0px",md:"0px 0px -20% 0px",lg:"0px 0px -30% 0px"};return e[t]||e.md}initIntroAnimations(){const t=document.querySelectorAll("[data-intro]:not(.intro-visible)");if(typeof window.shouldAnimate=="function"&&!window.shouldAnimate()){t.forEach(o=>{o.classList.add("intro-visible")});return}if(!("IntersectionObserver"in window)){t.forEach(o=>{o.classList.add("intro-visible")});return}this.introObserver&&(this.introObserver.disconnect(),this.introObserver=null);let e=[],i=!1;const n=100,s=()=>{if(e.length===0){i=!1;return}i=!0,e.shift().classList.add("intro-visible"),setTimeout(s,n)},r=this.getAnimationRootMargin();this.introObserver=new IntersectionObserver(o=>{o.forEach(l=>{if(l.isIntersecting){const d=l.target;this.introObserver.unobserve(d),e.push(d),i||s()}})},{root:null,rootMargin:r,threshold:.01});const a=o=>{const l=o.getBoundingClientRect(),d=window.innerHeight||document.documentElement.clientHeight,h=parseInt(r.split(" ")[2])||0;return l.top<d+h&&l.bottom>0};t.forEach(o=>{a(o)?(e.push(o),i||s()):this.introObserver.observe(o)})}splitTextReveal(t,e={}){if(!t)return null;const{timeline:i=null,duration:n=1.2,stagger:s=.1,ease:r="power4.out",delay:a=0,lineClass:o="split-line"}=e,l=new v(t,{type:"lines",linesClass:o});l.lines.forEach((f,b)=>{const S=document.createElement("div");S.style.overflow="hidden",S.style.display="block",f.parentNode.insertBefore(S,f),S.appendChild(f)}),c.set(l.lines,{yPercent:100});const d={yPercent:0,duration:n,ease:r,stagger:s};let h;return i?h=i.to(l.lines,d,a):(d.delay=a,h=c.to(l.lines,d)),{split:l,animation:h}}initSplitTextAnimations(){const t=document.querySelectorAll("[data-split-text]:not([data-split-initialized])"),e=this.getScrollTriggerStart();t.forEach(i=>{const n=i.dataset.splitLineClass||"split-line",s=parseFloat(i.dataset.splitDuration)||1.2,r=parseFloat(i.dataset.splitStagger)||.1,a=parseFloat(i.dataset.splitDelay)||0,o=i.dataset.splitScrollTrigger!=="false";if(i.dataset.splitInitialized="true",o){const l=m.create({trigger:i,start:e,once:!0,onEnter:()=>{this.splitTextReveal(i,{duration:s,stagger:r,delay:a,lineClass:n})}});this.scrollTriggers.push(l)}else this.splitTextReveal(i,{duration:s,stagger:r,delay:a,lineClass:n})})}animateHeaderSubtitle(t,e,i=.4){const n=e.querySelector("[data-subtitle-line]"),s=e.querySelector("[data-subtitle-text]");n&&c.set(n,{scaleX:0}),s&&c.set(s,{yPercent:100}),n&&t.to(n,{scaleX:1,duration:.8,ease:"power3.out"},i),s&&t.to(s,{yPercent:0,duration:.8,ease:"power4.out"},i+.2)}createHeroAnimation(t){const e=c.timeline(),i=t.querySelector("[data-hero-title]"),n=t.querySelector("[data-hero-subtitle]"),s=t.querySelector("[data-hero-cta]"),r=t.querySelector("[data-hero-image]");return r&&e.from(r,{scale:1.1,opacity:0,duration:1.2,ease:"power2.out"}),i&&e.from(i,{y:60,opacity:0,duration:.8,ease:"power2.out"},"-=0.8"),n&&e.from(n,{y:40,opacity:0,duration:.6,ease:"power2.out"},"-=0.5"),s&&e.from(s,{y:20,opacity:0,duration:.5,ease:"power2.out"},"-=0.3"),this.animations.push(e),e}killScrollTriggers(){this.scrollTriggers.forEach(t=>t.kill()),this.scrollTriggers=[]}killAnimations(){this.animations.forEach(t=>t.kill()),this.animations=[]}refresh(){m.refresh()}destroy(){this.killScrollTriggers(),this.killAnimations(),this.introObserver&&(this.introObserver.disconnect(),this.introObserver=null)}}const T=new W;c.registerPlugin(m,v);class Y{constructor(){this.scrollTriggers=[],this.splitInstances=[],this.initialized=!1}getScrollStart(t="top 80%"){if(typeof window.getScrollStart=="function")return window.getScrollStart(t);const e=window.themeSettings?.animationTriggerOffset||"md",i={none:t,sm:"top 90%",md:"top 80%",lg:"top 70%"};return i[e]||i.md}shouldAnimate(){if(typeof window.shouldAnimate=="function")return window.shouldAnimate();const t=window.matchMedia("(prefers-reduced-motion: reduce)").matches,e=window.themeSettings?.enableAnimations!==!1;return!t&&e}getAnimationConfig(t){const e={fade:{initial:{opacity:0},animate:{opacity:1},duration:.6,ease:"power2.out"},"fade-up":{initial:{opacity:0,y:30},animate:{opacity:1,y:0},duration:.6,ease:"power2.out"},"fade-down":{initial:{opacity:0,y:-30},animate:{opacity:1,y:0},duration:.6,ease:"power2.out"},"fade-left":{initial:{opacity:0,x:30},animate:{opacity:1,x:0},duration:.6,ease:"power2.out"},"fade-right":{initial:{opacity:0,x:-30},animate:{opacity:1,x:0},duration:.6,ease:"power2.out"},"split-text":{duration:1.2,ease:"power4.out",stagger:.1},"clip-right":{initial:{clipPath:"inset(0 100% 0 0)"},animate:{clipPath:"inset(0 0% 0 0)"},duration:1.2,ease:"power3.out"},"clip-up":{initial:{clipPath:"inset(100% 0 0 0)"},animate:{clipPath:"inset(0% 0 0 0)"},duration:1.2,ease:"power3.out"},"clip-down":{initial:{clipPath:"inset(0 0 100% 0)"},animate:{clipPath:"inset(0 0 0% 0)"},duration:1.2,ease:"power3.out"},scale:{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},duration:.8,ease:"power2.out"},"scale-up":{initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},duration:.8,ease:"back.out(1.7)"}};return e[t]||e["fade-up"]}initSplitText(t,e,i){const n=parseFloat(t.dataset.tweenDuration)||1.2,s=parseFloat(t.dataset.tweenStagger)||.1,r=t.dataset.tweenEase||"power4.out",a=new v(t,{type:"lines",linesClass:"tween-split-line"});return a.lines.forEach(o=>{const l=document.createElement("div");l.style.overflow="hidden",l.style.display="block",o.parentNode.insertBefore(l,o),l.appendChild(o)}),c.set(a.lines,{yPercent:120}),e.add(()=>{t.style.opacity="1"},i),e.to(a.lines,{yPercent:0,duration:n,ease:r,stagger:s},i),this.splitInstances.push(a),a}initTweenElement(t,e,i){const n=t.dataset.tweenType||"fade-up",s=this.getAnimationConfig(n),r=parseFloat(t.dataset.tweenDuration)||s.duration,a=t.dataset.tweenEase||s.ease;n==="split-text"?this.initSplitText(t,e,i):(c.set(t,s.initial),e.to(t,{...s.animate,duration:r,ease:a},i))}initTweenGroup(t){t.dataset.tweenGroup;const e=t.querySelectorAll("[data-tween]");if(e.length===0)return;const i=t.dataset.tweenStart||this.getScrollStart(),n=parseFloat(t.dataset.tweenStagger)||.15,s=c.timeline({scrollTrigger:{trigger:t,start:i,once:!0}});let r=0;e.forEach((a,o)=>{const l=a.dataset.tweenType||"fade-up",d=parseFloat(a.dataset.tweenDelay)||0;this.getAnimationConfig(l);const h=o===0?d:r+d;this.initTweenElement(a,s,h),r=h+(l==="split-text"?.3:n)}),this.scrollTriggers.push(s.scrollTrigger)}initStandaloneTweens(){const t=document.querySelectorAll("[data-tween]:not([data-tween-initialized])"),e=this.getScrollStart();t.forEach(i=>{if(i.closest("[data-tween-group]"))return;const n=i.dataset.tweenType||"fade-up",s=parseFloat(i.dataset.tweenDelay)||0,r=this.getAnimationConfig(n),a=parseFloat(i.dataset.tweenDuration)||r.duration,o=i.dataset.tweenEase||r.ease,l=i.dataset.tweenStart||e;if(i.dataset.tweenInitialized="true",n==="split-text"){const d=c.timeline({scrollTrigger:{trigger:i,start:l,once:!0}});this.initSplitText(i,d,s),this.scrollTriggers.push(d.scrollTrigger)}else{c.set(i,r.initial);const d=m.create({trigger:i,start:l,once:!0,onEnter:()=>{c.to(i,{...r.animate,duration:a,ease:o,delay:s})}});this.scrollTriggers.push(d)}})}init(){if(!this.shouldAnimate()){this.showAllElements();return}document.querySelectorAll("[data-tween-group]:not([data-tween-group-initialized])").forEach(e=>{e.dataset.tweenGroupInitialized="true",this.initTweenGroup(e)}),this.initStandaloneTweens(),this.initialized=!0}showAllElements(){document.querySelectorAll("[data-tween]").forEach(e=>{e.style.opacity="1",e.style.transform="none",e.style.clipPath="none"})}refresh(){m.refresh()}destroy(){this.scrollTriggers.forEach(t=>{t&&t.kill&&t.kill()}),this.scrollTriggers=[],this.splitInstances.forEach(t=>{t&&t.revert&&t.revert()}),this.splitInstances=[],document.querySelectorAll("[data-tween-initialized]").forEach(t=>{delete t.dataset.tweenInitialized}),document.querySelectorAll("[data-tween-group-initialized]").forEach(t=>{delete t.dataset.tweenGroupInitialized}),this.initialized=!1}reinit(){this.destroy(),this.init()}}const x=new Y;class K{constructor(){this.container=null,this.queue=[],this.current=null}ensureContainer(){this.container||(this.container=document.createElement("div"),this.container.className="toast-container",this.container.setAttribute("role","status"),this.container.setAttribute("aria-live","polite"),document.body.appendChild(this.container))}show(t,e={}){const{type:i="info",duration:n=4e3}=e;this.ensureContainer();const s=document.createElement("div");return s.className=`toast toast--${i}`,s.innerHTML=`
      ...
      <li class="cart-drawer__item" data-cart-item data-line-index="${e}">
        <div class="cart-drawer__item-image">
          ${t.image?`
            <a href="${t.url}">
              <img
                src="${p.getSizedImageUrl(t.image,"200x")}"
                alt="${t.title}"
        ...
        <div class="cart-drawer__item-details">
          ...
          <div class="cart-drawer__item-price">
            ${n?`<span class="cart-drawer__item-price--compare">${p.formatMoney(s)}</span>`:""}
            <span class="${n?"sale-price":""}">${p.formatMoney(t.final_line_price)}</span>
          </div>
    ...
    `}renderFooter(t){const e=window.themeStrings?.cartAddNote||"Add a note",i=window.themeStrings?.cartNotePlaceholder||"Add special instructions...",n=window.themeStrings?.cartSubtotal||"Subtotal",s=window.themeStrings?.cartTaxesNote||"Taxes and shipping calculated at checkout",r=window.themeStrings?.cartViewCart||"View cart",a=window.themeStrings?.cartCheckout||"Checkout",o=window.routes?.cartUrl||"/cart";return`
      <div class="p-6 border-t border-[--color-border] bg-[--color-background]" data-cart-drawer-footer>
        ...
        <div class="flex justify-between items-center text-base font-semibold mb-2">
          <span>${n}</span>
          <span data-cart-subtotal>${p.formatMoney(t.total_price)}</span>
        </div>
    ...
    `}async refresh(){await p.fetch(),this.render()}reinit(){this.destroy(),this.init()}destroy(){if(!this.drawer)return;this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.drawer.querySelectorAll("[data-cart-drawer-close]").forEach(e=>{e.removeEventListener("click",this.boundHandlers.handleClose)}),this.drawer.removeEventListener("click",this.boundHandlers.handleClick),this.drawer.removeEventListener("click",this.boundHandlers.handleLinkClick),this.drawer.removeEventListener("change",this.boundHandlers.handleChange);const t=this.drawer.querySelector("[data-cart-note]");t&&t.removeEventListener("input",this.boundHandlers.handleNoteInput),document.removeEventListener("keydown",this.boundHandlers.handleKeydown),document.removeEventListener("cart:open",this.boundHandlers.open),document.removeEventListener("cart:toggle",this.boundHandlers.toggle),window.removeEventListener("swup:contentReplaced",this.boundHandlers.closeOnNavigation),clearTimeout(this.noteTimeout),this.focusTrap&&(this.focusTrap.destroy(),this.focusTrap=null),this.drawer=null,this.backdrop=null,this.panel=null,this.isOpen=!1,this.isAnimating=!1}}const E=new X;class J{constructor(){this.wrapper=null,this.noteTimeout=null,this.isInitialized=!1,this.isReady=!1,this.unsubscribe=null}init(){this.wrapper=document.querySelector("[data-cart-wrapper]"),this.wrapper&&(this.wrapper.dataset.cartPageInitialized||(this.wrapper.dataset.cartPageInitialized="true",this.unsubscribe=p.subscribe((t,e)=>{this.onCartStateChange(t,e)}),this.bindEvents(),this.initAnimations(),this.isInitialized=!0))}onCartStateChange(t,e){this.wrapper&&(e?this.wrapper.classList.add("is-updating"):(this.wrapper.classList.remove("is-updating"),t&&this.isReady&&this.render()))}bindEvents(){this.wrapper.addEventListener("click",async e=>{const i=e.target.closest("[data-quantity-minus]"),n=e.target.closest("[data-quantity-plus]"),s=e.target.closest("[data-remove-item]");if(i||n||s){e.preventDefault();const r=e.target.closest("[data-cart-item]"),a=parseInt(r?.dataset.line),o=r?.querySelector("[data-quantity-input]");let l=parseInt(o?.value||0);i&&l>0&&l--,n&&l++,s&&(l=0),await p.updateLine(a,l)}}),this.wrapper.addEventListener("change",async e=>{if(e.target.matches("[data-quantity-input]")){const i=parseInt(e.target.dataset.line),n=parseInt(e.target.value)||0;await p.updateLine(i,n)}});const t=this.wrapper.querySelector("[data-cart-note]");t&&t.addEventListener("input",e=>{clearTimeout(this.noteTimeout),this.noteTimeout=setTimeout(()=>{p.updateNote(e.target.value)},500)})}initAnimations(){if(typeof window.shouldAnimate=="function"&&!window.shouldAnimate()){this.wrapper.classList.remove("is-loading"),this.wrapper.classList.add("is-ready"),this.isReady=!0;return}const t=window.gsap||window.pieces&&window.pieces.gsap;if(!t){setTimeout(()=>this.initAnimations(),50);return}const e=this.wrapper.querySelectorAll("[data-cart-item]"),i=this.wrapper.querySelector(".cart-summary"),n=this.wrapper.querySelector(".cart-empty"),s=t.timeline({onComplete:()=>{this.wrapper.classList.add("is-ready"),this.isReady=!0}}),r=this.wrapper.querySelectorAll(".cart-page-title-line > span");r.length&&s.fromTo(r,{yPercent:120},{yPercent:0,duration:1.2,ease:"power4.out",stagger:.1,immediateRender:!0},0);const a=this.wrapper.querySelector("[data-subtitle-line]"),o=this.wrapper.querySelector("[data-subtitle-text]");a&&s.fromTo(a,{scaleX:0},{scaleX:1,duration:.8,ease:"power3.out",immediateRender:!0},.4),o&&s.fromTo(o,{yPercent:120},{yPercent:0,duration:.8,ease:"power4.out",immediateRender:!0},.6),e.length&&e.forEach((l,d)=>{const h=l.querySelector(".cart-item-image");s.fromTo(l,{opacity:0,y:30},{opacity:1,y:0,duration:.6,ease:"power3.out"},.5+d*.1),h&&s.fromTo(h,{clipPath:"inset(0 100% 0 0)"},{clipPath:"inset(0 0% 0 0)",duration:1,ease:"expo.inOut"},.5+d*.1)}),i&&s.fromTo(i,{opacity:0,y:30},{opacity:1,y:0,duration:.8,ease:"power3.out"},.7),n&&s.fromTo(n,{opacity:0},{opacity:1,duration:.8,ease:"power3.out"},.5),this.wrapper.classList.remove("is-loading")}render(){const t=p.get();if(!t||!this.wrapper)return;const e=this.wrapper.querySelector("[data-subtitle-text]");if(e){const i=t.item_count===1?"Item":"Items";e.textContent=`${t.item_count} ${i}`}t.item_count===0?this.renderEmptyState():this.renderCartContent(t)}renderEmptyState(){const t=this.wrapper.querySelector(".lg\\:grid")||this.wrapper.querySelector("[data-cart-form]")?.parentElement?.parentElement,e=window.themeStrings?.cartEmpty||"Your cart is empty",i=window.themeStrings?.cartEmptyDescription||"Looks like you haven't added anything yet.",n=window.themeStrings?.cartStartShopping||"Start Shopping",s=window.themeStrings?.backHome||"Back to Home",r=window.routes?.allProductsCollectionUrl||"/collections/all",a=window.routes?.rootUrl||"/",o=this.wrapper.querySelector('[class*="page-container"]')?"page-container":"page-full";t&&(t.outerHTML=`
        ...
        <div class="flex gap-6">
          <div class="cart-item-image w-28 h-36 flex-shrink-0 overflow-hidden bg-[--color-background-secondary]" style="clip-path: inset(0 0% 0 0);">
            ${t.image?`
              <a href="${t.url}">
                <img
                  src="${p.getSizedImageUrl(t.image,"300x")}"
                  alt="${t.title}"
                  class="w-full h-full object-cover"
                  loading="lazy"
                >
            ...
            <div>
              <div class="flex justify-between">
                ...
                <div class="text-right">
                  <p class="text-base font-medium text-[--color-text]">${p.formatMoney(t.final_line_price)}</p>
                  ${n?`<p class="text-sm text-[--color-text-secondary] line-through">${p.formatMoney(t.original_line_price)}</p>`:""}
                </div>
              </div>
            </div>
    ...
    `}updateSummary(t){const e=this.wrapper.querySelector("[data-cart-subtotal]");e&&(e.textContent=p.formatMoney(t.total_price));const i=this.wrapper.querySelector("[data-cart-total]");i&&(i.textContent=p.formatMoney(t.total_price));const n=this.wrapper.querySelector("[data-cart-note]");n&&t.note!==n.value&&(n.value=t.note||"")}reinit(){this.destroy(),this.init()}destroy(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),clearTimeout(this.noteTimeout),this.wrapper=null,this.isInitialized=!1,this.isReady=!1}}const _=new J;function H(u,t){try{return t!==void 0?(localStorage.setItem(u,t),!0):localStorage.getItem(u)}catch{return t!==void 0?!1:null}}function Z(u,t){let e;return function(...i){clearTimeout(e),e=setTimeout(()=>u.apply(this,i),t)}}class y extends HTMLElement{constructor(){super(),this.boundHandlers={}}connectedCallback(){this.sectionId=this.dataset.sectionId,this.form=this.querySelector("[data-facets-form]"),this.drawer=this.querySelector("#FacetsDrawer"),this.loading=this.querySelector("[data-facets-loading]"),this.drawer&&document.body.appendChild(this.drawer),this.boundHandlers.onFormChange=Z(this.onFormChange.bind(this),500),this.boundHandlers.onActiveFilterClick=this.onActiveFilterClick.bind(this),this.boundHandlers.onKeydown=this.onKeydown.bind(this),this.boundHandlers.onPopState=this.onPopState.bind(this),this.bindEvents(),this.setupHistoryListener()}disconnectedCallback(){document.removeEventListener("keydown",this.boundHandlers.onKeydown),window.removeEventListener("popstate",this.boundHandlers.onPopState),this.drawer&&this.drawer.parentNode===document.body&&this.drawer.remove()}bindEvents(){this.form&&this.form.addEventListener("input",this.boundHandlers.onFormChange);const t=this.querySelector("[data-facets-open]");t&&t.addEventListener("click",()=>this.openDrawer()),this.drawer&&this.drawer.addEventListener("click",n=>{(n.target.closest("[data-facets-close]")||n.target.closest("[data-facets-apply]"))&&this.closeDrawer();const s=n.target.closest("[data-facet-clear-all]");if(s){n.preventDefault();const r=s.href,a=r.includes("?")?r.slice(r.indexOf("?")+1):"";this.renderPage(a),this.closeDrawer()}}),this.querySelectorAll("[data-facet-remove], [data-facet-clear-all]").forEach(n=>{n.addEventListener("click",this.boundHandlers.onActiveFilterClick)});const e=this.querySelector("#SortBy");e&&e.addEventListener("change",this.boundHandlers.onFormChange);const i=this.querySelector("#SortByMobile");i&&i.addEventListener("change",n=>{e&&(e.value=n.target.value)}),document.addEventListener("keydown",this.boundHandlers.onKeydown),this.setupViewToggle()}setupViewToggle(){const t=this.querySelectorAll("[data-view-toggle]"),e=document.querySelector("[data-collection-wrapper]");if(!t.length||!e)return;const i=H("collection-view")||"grid";e.dataset.view=i,t.forEach(n=>{const s=n.dataset.viewToggle===i;n.classList.toggle("is-active",s),n.setAttribute("aria-pressed",s)}),t.forEach(n=>{n.addEventListener("click",()=>{const s=n.dataset.viewToggle,r=e.dataset.view;if(s===r)return;const a=e.querySelector("[data-collection-content]"),o=typeof window.shouldAnimate=="function"&&window.shouldAnimate(),l=window.gsap||window.pieces?.gsap;if(t.forEach(d=>{const h=d.dataset.viewToggle===s;d.classList.toggle("is-active",h),d.setAttribute("aria-pressed",h)}),o&&l&&a){const d=a.offsetHeight;l.to(a,{opacity:0,duration:.2,ease:"power2.in",onComplete:()=>{a.style.height=`${d}px`,a.style.overflow="hidden",e.dataset.view=s,a.style.height="auto";const h=a.offsetHeight;a.style.height=`${d}px`,l.to(a,{height:h,duration:.4,ease:"power3.inOut"}),l.to(a,{opacity:1,duration:.3,delay:.2,ease:"power2.out",onComplete:()=>{a.style.height="",a.style.overflow="",window.pieces?.lenis&&window.pieces.lenis.resize()}})}})}else e.dataset.view=s,window.pieces?.lenis&&window.pieces.lenis.resize();H("collection-view",s)})})}setupHistoryListener(){y.searchParamsInitial=window.location.search.slice(1),y.searchParamsPrev=window.location.search.slice(1),window.addEventListener("popstate",this.boundHandlers.onPopState)}onKeydown(t){t.key==="Escape"&&this.isDrawerOpen()&&this.closeDrawer()}onPopState(t){const e=t.state?.searchParams??y.searchParamsInitial;e!==y.searchParamsPrev&&this.renderPage(e,!1)}isDrawerOpen(){return this.drawer&&!this.drawer.hasAttribute("inert")}openDrawer(){if(!this.drawer)return;this.scrollPosition=window.scrollY,document.body.style.top=`-${this.scrollPosition}px`,document.documentElement.classList.add("scroll-locked"),window.pieces?.lenis&&window.pieces.lenis.stop(),this.drawer.removeAttribute("inert"),this.drawer.classList.add("is-open");const t=this.querySelector("[data-facets-open]");t&&t.setAttribute("aria-expanded","true"),requestAnimationFrame(()=>{const e=this.drawer.querySelector("[data-facets-close]");e&&e.focus()})}closeDrawer(){if(!this.drawer)return;this.drawer.classList.remove("is-open"),setTimeout(()=>{this.drawer.setAttribute("inert",""),document.documentElement.classList.remove("scroll-locked"),document.body.style.top="",window.scrollTo(0,this.scrollPosition||0),window.pieces?.lenis&&window.pieces.lenis.start()},300);const t=this.querySelector("[data-facets-open]");t&&(t.setAttribute("aria-expanded","false"),t.focus())}onFormChange(t){const e=new FormData(this.form),i=document.querySelector("#SortBy");i&&i.value&&e.set("sort_by",i.value);const n=new URLSearchParams(e).toString();this.renderPage(n)}onActiveFilterClick(t){t.preventDefault();const e=t.currentTarget.href,i=e.includes("?")?e.slice(e.indexOf("?")+1):"";this.renderPage(i)}async renderPage(t,e=!0){y.searchParamsPrev=t,this.showLoading();try{const i=`${window.location.pathname}?section_id=${this.sectionId}&${t}`,s=await(await fetch(i)).text(),a=new DOMParser().parseFromString(s,"text/html");this.updateProductGrid(a),this.updateFilters(a),this.updateActiveFacets(a),this.updateProductCount(a),this.updatePagination(a),e&&this.updateURL(t),window.pieces?.lenis&&window.pieces.lenis.resize()}catch{}finally{this.hideLoading()}}updateProductGrid(t){const e=t.querySelector("[data-collection-content]"),i=document.querySelector("[data-collection-content]");if(e&&i){const n=document.querySelector("[data-collection-wrapper]");n&&n.classList.add("is-transitioning"),i.replaceChildren(...e.cloneNode(!0).childNodes),requestAnimationFrame(()=>{n&&(n.classList.remove("is-transitioning"),this.animateNewItems(i)),document.dispatchEvent(new CustomEvent("facets:updated"))})}}animateNewItems(t){const e=t.querySelectorAll("[data-collection-item], [data-product-card]");e.forEach(i=>{i.hasAttribute("data-intro")&&i.classList.add("intro-visible"),i.querySelectorAll("[data-intro]").forEach(n=>{n.classList.add("intro-visible")})}),typeof gsap<"u"&&e.forEach((i,n)=>{const s=i.querySelector(".product-card-image"),r=i.querySelectorAll(".product-card-title .overflow-hidden span"),a=i.querySelectorAll(".product-card-price .overflow-hidden span");s&&gsap.set(s,{clipPath:"inset(0 100% 0 0)"}),r.length&&gsap.set(r,{yPercent:100}),a.length&&gsap.set(a,{yPercent:100});const o=n%4*.1;gsap.delayedCall(o,()=>{const l=gsap.timeline();s&&l.to(s,{clipPath:"inset(0 0% 0 0)",duration:1.2,ease:"expo.inOut"},0),r.length&&l.to(r,{yPercent:0,duration:.8,ease:"power4.out",stagger:.05},.2),a.length&&l.to(a,{yPercent:0,duration:.6,ease:"power4.out",stagger:.05},.3)})})}updateFilters(t){const e=t.querySelector(".facets-drawer__filters"),i=this.querySelector(".facets-drawer__filters");if(e&&i){const n=[...i.querySelectorAll("details[open]")].map(s=>s.id);i.replaceChildren(...e.cloneNode(!0).childNodes),n.forEach(s=>{const r=i.querySelector(`#${s}`);r&&(r.open=!0)}),i.querySelectorAll(".facets-disclosure").forEach(s=>{s.addEventListener("toggle",()=>{const r=s.querySelector(".ph-caret-down");r&&(r.style.transform=s.open?"rotate(180deg)":"")})})}}updateActiveFacets(t){const e=t.querySelector("#ActiveFacets"),i=this.querySelector("#ActiveFacets");e&&i&&(i.outerHTML=e.outerHTML,this.querySelectorAll("[data-facet-remove], [data-facet-clear-all]").forEach(s=>{s.addEventListener("click",this.boundHandlers.onActiveFilterClick)}));const n=this.querySelector("[data-facets-open]");if(n){const s=t.querySelector("[data-facets-open]");s&&n.replaceChildren(...s.cloneNode(!0).childNodes)}}updateProductCount(t){const e=t.querySelector("#ProductCount"),i=this.querySelector("#ProductCount");e&&i&&i.replaceChildren(...e.cloneNode(!0).childNodes)}updatePagination(t){const e=t.querySelector("[data-pagination-load-more]"),i=document.querySelector("[data-pagination-load-more]");i&&(e?i.replaceChildren(...e.cloneNode(!0).childNodes):i.replaceChildren());const n=t.querySelector(".collection-wrapper nav"),s=document.querySelector(".collection-wrapper nav");s&&n?s.replaceChildren(...n.cloneNode(!0).childNodes):s&&!n&&s.remove()}updateURL(t){const e=new URLSearchParams(t);e.delete("section_id");const i=e.toString(),n=i?`${window.location.pathname}?${i}`:window.location.pathname;history.pushState({searchParams:i},"",n)}showLoading(){this.loading&&(this.loading.style.opacity="1",this.loading.style.pointerEvents="auto")}hideLoading(){this.loading&&(this.loading.style.opacity="0",this.loading.style.pointerEvents="none")}}customElements.get("facet-filters-form")||customElements.define("facet-filters-form",y);c.registerPlugin(m,$,v);window.gsap=c;window.Flip=$;window.SplitText=v;window.Lenis=I;function q(){x.init(),T.initIntroAnimations()}function F(){window._articleProgressCleanup&&(window._articleProgressCleanup(),window._articleProgressCleanup=null);const u=document.getElementById("article-progress"),t=document.getElementById("article-progress-bar"),e=document.querySelector("[data-article-wrapper]");if(!u||!t)return;if(!e){u.style.display="none",t.style.width="0%";return}u.style.display="block",t.style.width="0%";let i=!1;function n(){return window.pieces&&window.pieces.lenis&&window.pieces.lenis.lenis?window.pieces.lenis.lenis.scroll:window.scrollY}function s(){if(i)return;const h=n(),f=e.getBoundingClientRect(),b=h+f.top,S=e.offsetHeight,M=window.innerHeight,C=b,L=b+S-M,A=h;let k=0;A>=C&&A<=L?k=(A-C)/(L-C)*100:A>L&&(k=100),t.style.width=`${Math.min(100,Math.max(0,k))}%`}let r=null;function a(){if(window.pieces&&window.pieces.lenis&&window.pieces.lenis.lenis){const h=window.pieces.lenis.lenis;return r=()=>s(),h.on("scroll",r),!0}return!1}if(!a()){let b=function(){if(!i){if(a()){s();return}h++,h<f&&setTimeout(b,100)}},h=0;const f=50;b()}let o=!1;function l(){o||(requestAnimationFrame(()=>{s(),o=!1}),o=!0)}window.addEventListener("scroll",l,{passive:!0}),s();function d(){i=!0,window.removeEventListener("scroll",l),r&&window.pieces&&window.pieces.lenis&&window.pieces.lenis.lenis&&window.pieces.lenis.lenis.off("scroll",r),u&&(u.style.display="none"),t&&(t.style.width="0%")}window._articleProgressCleanup=d}function tt(){const u=()=>{requestAnimationFrame(()=>{typeof window.shouldAnimate=="function"&&window.shouldAnimate()&&(x.reinit(),T.refresh(),q(),m.refresh()),E.reinit(),_.reinit()})};document.fonts&&document.fonts.ready?document.fonts.ready.then(u):u()}function et(){setTimeout(()=>{F()},100)}function it(){document.addEventListener("menu:open",()=>{w.stop()}),document.addEventListener("menu:close",()=>{w.start()})}function D(){const u=window.matchMedia("(prefers-reduced-motion: reduce)").matches,t=window.themeSettings?.enableSmoothScroll!==!1;!u&&t&&w.init();const e=window.themeSettings?.enablePageTransitions!==!1;!u&&e&&(P.init(),window.addEventListener("swup:contentReplaced",tt),window.addEventListener("swup:transitionEnd",et));const i=window.themeSettings?.enableAnimations!==!1;!u&&i&&(document.fonts&&document.fonts.ready?document.fonts.ready.then(()=>{requestAnimationFrame(()=>{q(),m.refresh()})}):requestAnimationFrame(()=>{q()})),requestAnimationFrame(()=>{F()}),it(),p.init(),p.subscribe(n=>{n&&document.querySelectorAll("[data-cart-count]").forEach(s=>{s.textContent=n.item_count,n.item_count>0?s.removeAttribute("hidden"):s.setAttribute("hidden","")})}),E.init(),_.init(),document.addEventListener("cart:updated",()=>{P.clearCache("/cart")}),document.addEventListener("click",n=>{const s=n.target.closest('a[href^="#"]');if(s&&s.getAttribute("href").length>1){n.preventDefault();const r=document.querySelector(s.getAttribute("href"));r&&w.scrollTo(r,{offset:-100})}}),window.pieces={lenis:w,swup:P,animation:T,tween:x,cartState:p,cartDrawer:E,cartPage:_,gsap:c,ScrollTrigger:m,Flip:$,SplitText:v,Lenis:I},window.openCartDrawer=()=>E.open(),window.closeCartDrawer=()=>E.close(),window.refreshCartDrawer=()=>E.refresh()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",D):D();window.Shopify&&window.Shopify.designMode&&(document.addEventListener("shopify:section:load",()=>{typeof window.shouldAnimate=="function"&&window.shouldAnimate()&&(x.reinit(),T.refresh(),q())}),document.addEventListener("shopify:section:unload",()=>{x.destroy(),T.destroy()}),document.addEventListener("shopify:section:reorder",()=>{typeof window.shouldAnimate=="function"&&window.shouldAnimate()&&(x.refresh(),T.refresh())}));
