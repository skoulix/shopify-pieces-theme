import{g as l,S as f,a as T,F as I}from"./pieces-gsap.js";import{L as H}from"./pieces-lenis.js";import{_ as z,s as R,i as B,l as U,o as V,r as j}from"./pieces-swup.js";l.registerPlugin(f);class W{constructor(){this.lenis=null,this.isInitialized=!1}init(){return this.isInitialized?this.lenis:(this.lenis=new H({duration:1.2,easing:t=>Math.min(1,1.001-Math.pow(2,-10*t)),orientation:"vertical",gestureOrientation:"vertical",smoothWheel:!0,wheelMultiplier:1,touchMultiplier:2,infinite:!1,prevent:t=>t.closest(".cart-drawer__content")||t.closest(".mobile-nav__content")||t.closest("[data-lenis-prevent]")}),this.lenis.on("scroll",f.update),l.ticker.add(t=>{this.lenis.raf(t*1e3)}),l.ticker.lagSmoothing(0),document.documentElement.classList.add("lenis"),this.isInitialized=!0,this.lenis)}scrollTo(t,e={}){if(!this.lenis)return;const i={offset:0,duration:1.2,easing:n=>Math.min(1,1.001-Math.pow(2,-10*n)),immediate:!1,lock:!1,onComplete:null};this.lenis.scrollTo(t,{...i,...e})}stop(){this.lenis&&this.lenis.stop()}start(){this.lenis&&this.lenis.start()}resize(){this.lenis&&this.lenis.resize()}destroy(){this.lenis&&(this.lenis.destroy(),this.lenis=null,this.isInitialized=!1,document.documentElement.classList.remove("lenis"))}get scroll(){return this.lenis?.scroll||0}get progress(){return this.lenis?.progress||0}get isScrolling(){return this.lenis?.isScrolling||!1}}const g=new W;l.registerPlugin(f);class Y{constructor(){this.swup=null,this.isInitialized=!1,this.pageTransitionDuration=.6,this.skipAnimation=!1,this.transitionStyle=window.themeSettings?.pageTransitionStyle||"slide",this.supportsViewTransitions=typeof document.startViewTransition=="function"}shouldUseViewTransitions(){return this.supportsViewTransitions&&window.themeSettings?.enableViewTransitions!==!1&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches}init(){if(this.isInitialized)return this.swup;if(window.Shopify&&window.Shopify.designMode)return null;window.addEventListener("error",e=>{if(e.message&&e.message.includes("Cannot assign to read only property 'protect'"))return e.preventDefault(),!0}),this.shouldUseViewTransitions()&&this.injectViewTransitionStyles();const t=[{from:"(.*)",to:"(.*)",out:async e=>{await this.animateOut(),e()},in:async e=>{await this.animateIn(),e()}}];return this.swup=new z({containers:["#swup-container"],cache:!0,animateHistoryBrowsing:!0,linkSelector:'a[href^="'+window.location.origin+'"]:not([data-no-swup]):not([href*="#"]), a[href^="/"]:not([data-no-swup]):not([href^="//"]):not([href^="#"]):not([href*="#"])',plugins:[new R(t),new B({persistAssets:!0,persistTags:'link[rel="stylesheet"], style, script[src]'}),new U({preloadVisibleLinks:!0}),new V,new j({head:!1,body:!0})]}),this.setupEventListeners(),this.isInitialized=!0,this.swup}setupEventListeners(){this.swup.hooks.on("visit:start",t=>{document.documentElement.classList.add("is-changing"),document.documentElement.classList.add("scroll-locked"),g.stop(),t.to.url.includes("/cart")&&this.swup.cache.delete(t.to.url)}),this.swup.hooks.on("content:replace",()=>{f.getAll().forEach(e=>e.kill()),this.reinitializeComponents();const t=document.querySelector("main");t&&(t.setAttribute("tabindex","-1"),t.focus({preventScroll:!0}),this.announcePageChange()),requestAnimationFrame(()=>{g.resize(),f.refresh()})}),this.swup.hooks.on("visit:end",()=>{document.documentElement.classList.remove("is-changing"),document.documentElement.classList.remove("scroll-locked"),g.start(),window.dispatchEvent(new CustomEvent("swup:transitionEnd"))}),this.swup.hooks.on("page:view",()=>{window.dispatchEvent(new CustomEvent("swup:pageview",{detail:{url:window.location.href}}))})}async animateOut(){if(this.skipAnimation||this.shouldUseViewTransitions()&&this._viewTransitionActive)return Promise.resolve();const t=document.querySelector("#swup-container"),e=document.querySelector(".page-transition-overlay"),i=l.timeline();switch(this.transitionStyle){case"fade":i.to(t,{opacity:0,duration:.4,ease:"power2.inOut"});break;case"slide":i.to(t,{y:-40,opacity:0,duration:.25,ease:"power2.in"});break;case"curtain":default:e&&(l.set(e,{transformOrigin:"bottom",scaleY:0}),i.to(e,{scaleY:1,duration:.4,ease:"power3.inOut"})),i.to(t,{y:-40,opacity:0,duration:.25,ease:"power2.in"},.1);break}return i}async animateIn(){g.scrollTo(0,{immediate:!0});const t=document.querySelector("#swup-container"),e=document.querySelector(".page-transition-overlay");if(this.skipAnimation)return this.skipAnimation=!1,l.set(t,{opacity:1,y:0,x:0}),e&&l.set(e,{scaleY:0,scaleX:0}),Promise.resolve();const i=l.timeline();switch(this.transitionStyle){case"fade":l.set(t,{opacity:0,x:0,y:0}),i.to(t,{opacity:1,duration:.4,ease:"power2.inOut"}),i.add(()=>{this.animateRevealElements()},.1);break;case"slide":l.set(t,{opacity:0,y:40,x:0}),i.to(t,{y:0,opacity:1,duration:.3,ease:"power2.out"}),i.add(()=>{this.animateRevealElements()},.1);break;case"curtain":default:l.set(t,{opacity:0,x:0,y:40}),e&&(l.set(e,{transformOrigin:"top",scaleY:1}),i.to(e,{scaleY:0,duration:.5,ease:"power3.inOut"})),i.to(t,{y:0,opacity:1,duration:.3,ease:"power2.out"},.2),i.add(()=>{this.animateRevealElements()},.3);break}return i}animateRevealElements(){document.querySelectorAll("[data-reveal]").forEach((e,i)=>{const n=e.dataset.revealDelay||i*.1;e.dataset.reveal,l.to(e,{opacity:1,x:0,y:0,scale:1,clipPath:"inset(0 0% 0 0)",duration:.8,delay:n,ease:"power2.out"})})}announcePageChange(){let t=document.getElementById("swup-announce");t||(t=document.createElement("div"),t.id="swup-announce",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sr-only",document.body.appendChild(t));const e=document.title||"Page loaded";t.textContent="",setTimeout(()=>{t.textContent=e},100)}reinitializeComponents(){window.dispatchEvent(new CustomEvent("swup:contentReplaced")),window.Shopify&&window.Shopify.PaymentButton&&window.Shopify.PaymentButton.init(),document.querySelectorAll("details-disclosure, details-modal").forEach(t=>{t.connectedCallback&&t.connectedCallback()})}navigateTo(t,e=!1){this.swup?(this.skipAnimation=e,this.swup.navigate(t)):window.location.href=t}updateUrl(t,e=!1){e?window.history.replaceState({swupPreview:!0},"",t):window.history.pushState({swupPreview:!0},"",t)}goBack(){window.history.back()}clearCache(t){if(!this.swup||!this.swup.cache)return;const e=Array.isArray(t)?t:[t];this.swup.cache.all.forEach((i,n)=>{e.some(s=>n.includes(s))&&this.swup.cache.delete(n)})}clearAllCache(){this.swup&&this.swup.cache&&this.swup.cache.clear()}injectViewTransitionStyles(){if(document.getElementById("view-transition-styles"))return;const t=document.createElement("style");t.id="view-transition-styles",t.textContent=`
    ...
    `}updateSummary(t){const e=this.wrapper.querySelector("[data-cart-subtotal]");e&&(e.textContent=u.formatMoney(t.total_price));const i=this.wrapper.querySelector("[data-cart-total]");i&&(i.textContent=u.formatMoney(t.total_price));const n=this.wrapper.querySelector("[data-cart-note]");n&&t.note!==n.value&&(n.value=t.note||"")}reinit(){this.destroy(),this.init()}destroy(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),clearTimeout(this.noteTimeout),this.wrapper=null,this.isInitialized=!1,this.isReady=!1}}const $=new Z;function F(d,t){try{return t!==void 0?(localStorage.setItem(d,t),!0):localStorage.getItem(d)}catch{return t!==void 0?!1:null}}function tt(d,t){let e;return function(...i){clearTimeout(e),e=setTimeout(()=>d.apply(this,i),t)}}class S extends HTMLElement{constructor(){super(),this.boundHandlers={}}connectedCallback(){this.sectionId=this.dataset.sectionId,this.form=this.querySelector("[data-facets-form]"),this.drawer=this.querySelector("#FacetsDrawer"),this.loading=this.querySelector("[data-facets-loading]"),this.drawer&&document.body.appendChild(this.drawer),this.boundHandlers.onFormChange=tt(this.onFormChange.bind(this),D.search),this.boundHandlers.onActiveFilterClick=this.onActiveFilterClick.bind(this),this.boundHandlers.onKeydown=this.onKeydown.bind(this),this.boundHandlers.onPopState=this.onPopState.bind(this),this.bindEvents(),this.setupHistoryListener()}disconnectedCallback(){document.removeEventListener("keydown",this.boundHandlers.onKeydown),window.removeEventListener("popstate",this.boundHandlers.onPopState),this.drawer&&this.drawer.parentNode===document.body&&this.drawer.remove()}bindEvents(){this.form&&this.form.addEventListener("input",this.boundHandlers.onFormChange);const t=this.querySelector("[data-facets-open]");t&&t.addEventListener("click",()=>this.openDrawer()),this.drawer&&this.drawer.addEventListener("click",n=>{(n.target.closest("[data-facets-close]")||n.target.closest("[data-facets-apply]"))&&this.closeDrawer();const s=n.target.closest("[data-facet-clear-all]");if(s){n.preventDefault();const r=s.href,a=r.includes("?")?r.slice(r.indexOf("?")+1):"";this.renderPage(a),this.closeDrawer()}}),this.querySelectorAll("[data-facet-remove], [data-facet-clear-all]").forEach(n=>{n.addEventListener("click",this.boundHandlers.onActiveFilterClick)});const e=this.querySelector("#SortBy");e&&e.addEventListener("change",this.boundHandlers.onFormChange);const i=this.querySelector("#SortByMobile");i&&i.addEventListener("change",n=>{e&&(e.value=n.target.value)}),document.addEventListener("keydown",this.boundHandlers.onKeydown),this.setupViewToggle()}setupViewToggle(){const t=this.querySelectorAll("[data-view-toggle]"),e=document.querySelector("[data-collection-wrapper]");if(!t.length||!e)return;const i=e.querySelector("[data-collection-content]"),n=e.querySelector("[data-collection-list-content]"),s=a=>{e.dataset.view=a,n&&(a==="list"?(i?.classList.add("hidden"),n.classList.remove("hidden")):(i?.classList.remove("hidden"),n.classList.add("hidden")))},r=F("collection-view")||"grid";s(r),t.forEach(a=>{const o=a.dataset.viewToggle===r;a.classList.toggle("is-active",o),a.setAttribute("aria-pressed",o)}),t.forEach(a=>{a.addEventListener("click",()=>{const o=a.dataset.viewToggle,c=e.dataset.view;if(o===c)return;const p=o==="list"?n:i,h=o==="list"?i:n,y=typeof window.shouldAnimate=="function"&&window.shouldAnimate(),w=window.gsap||window.pieces?.gsap;if(t.forEach(v=>{const m=v.dataset.viewToggle===o;v.classList.toggle("is-active",m),v.setAttribute("aria-pressed",m)}),y&&w&&p&&h){const v=h.offsetHeight;w.to(h,{opacity:0,duration:.2,ease:"power2.in",onComplete:()=>{s(o),w.set(p,{opacity:0});const m=e.querySelector("[data-product-grid-container]");if(m){m.style.height=`${v}px`,m.style.overflow="hidden";const q=p.offsetHeight;w.to(m,{height:q,duration:.4,ease:"power3.inOut",onComplete:()=>{m.style.height="",m.style.overflow=""}})}w.to(p,{opacity:1,duration:.3,delay:.15,ease:"power2.out",onComplete:()=>{window.pieces?.lenis&&window.pieces.lenis.resize()}})}})}else s(o),window.pieces?.lenis&&window.pieces.lenis.resize();F("collection-view",o)})})}setupHistoryListener(){S.searchParamsInitial=window.location.search.slice(1),S.searchParamsPrev=window.location.search.slice(1),window.addEventListener("popstate",this.boundHandlers.onPopState)}onKeydown(t){t.key==="Escape"&&this.isDrawerOpen()&&this.closeDrawer()}onPopState(t){const e=t.state?.searchParams??S.searchParamsInitial;e!==S.searchParamsPrev&&this.renderPage(e,!1)}isDrawerOpen(){return this.drawer&&!this.drawer.hasAttribute("inert")}openDrawer(){if(!this.drawer)return;this.scrollPosition=window.scrollY,document.body.style.top=`-${this.scrollPosition}px`,document.documentElement.classList.add("scroll-locked"),window.pieces?.lenis&&window.pieces.lenis.stop(),this.drawer.removeAttribute("inert"),this.drawer.classList.add("is-open");const t=this.querySelector("[data-facets-open]");t&&t.setAttribute("aria-expanded","true"),requestAnimationFrame(()=>{const e=this.drawer.querySelector("[data-facets-close]");e&&e.focus()})}closeDrawer(){if(!this.drawer)return;this.drawer.classList.remove("is-open"),setTimeout(()=>{this.drawer.setAttribute("inert",""),document.documentElement.classList.remove("scroll-locked"),document.body.style.top="",window.scrollTo(0,this.scrollPosition||0),window.pieces?.lenis&&window.pieces.lenis.start()},A.normal);const t=this.querySelector("[data-facets-open]");t&&(t.setAttribute("aria-expanded","false"),t.focus())}onFormChange(t){const e=new FormData(this.form),i=document.querySelector("#SortBy");i&&i.value&&e.set("sort_by",i.value);const n=new URLSearchParams(e).toString();this.renderPage(n)}onActiveFilterClick(t){t.preventDefault();const e=t.currentTarget.href,i=e.includes("?")?e.slice(e.indexOf("?")+1):"";this.renderPage(i)}async renderPage(t,e=!0){S.searchParamsPrev=t,this.showLoading();try{const i=`${window.location.pathname}?section_id=${this.sectionId}&${t}`,s=await(await fetch(i)).text(),a=new DOMParser().parseFromString(s,"text/html");this.updateProductGrid(a),this.updateFilters(a),this.updateActiveFacets(a),this.updateProductCount(a),this.updatePagination(a),e&&this.updateURL(t),window.pieces?.lenis&&window.pieces.lenis.resize()}catch{}finally{this.hideLoading()}}updateProductGrid(t){const e=t.querySelector("[data-collection-content]"),i=document.querySelector("[data-collection-content]");if(e&&i){const n=document.querySelector("[data-collection-wrapper]");n&&n.classList.add("is-transitioning"),i.replaceChildren(...e.cloneNode(!0).childNodes),requestAnimationFrame(()=>{n&&(n.classList.remove("is-transitioning"),this.animateNewItems(i)),document.dispatchEvent(new CustomEvent("facets:updated"))})}}animateNewItems(t){const e=t.querySelectorAll("[data-collection-item], [data-product-card]");window.pieces?.tween&&window.pieces.tween.reinit(),typeof gsap<"u"&&e.forEach((i,n)=>{const s=i.querySelector(".product-card-image"),r=i.querySelectorAll(".product-card-title .overflow-hidden span"),a=i.querySelectorAll(".product-card-price .overflow-hidden span");s&&gsap.set(s,{clipPath:"inset(0 100% 0 0)"}),r.length&&gsap.set(r,{yPercent:100}),a.length&&gsap.set(a,{yPercent:100});const o=n%4*.1;gsap.delayedCall(o,()=>{const c=gsap.timeline();s&&c.to(s,{clipPath:"inset(0 0% 0 0)",duration:1.2,ease:"expo.inOut"},0),r.length&&c.to(r,{yPercent:0,duration:.8,ease:"power4.out",stagger:.05},.2),a.length&&c.to(a,{yPercent:0,duration:.6,ease:"power4.out",stagger:.05},.3)})})}updateFilters(t){const e=t.querySelector(".facets-drawer__filters"),i=this.drawer?.querySelector(".facets-drawer__filters");if(e&&i){const n=[...i.querySelectorAll("details[open]")].map(s=>s.id);i.replaceChildren(...e.cloneNode(!0).childNodes),n.forEach(s=>{const r=i.querySelector(`#${s}`);r&&(r.open=!0)}),i.querySelectorAll(".facets-disclosure").forEach(s=>{s.addEventListener("toggle",()=>{const r=s.querySelector(".ph-caret-down");r&&(r.style.transform=s.open?"rotate(180deg)":"")})})}}updateActiveFacets(t){const e=t.querySelector("#ActiveFacets"),i=this.querySelector("#ActiveFacets");e&&i&&(i.outerHTML=e.outerHTML,this.querySelectorAll("[data-facet-remove], [data-facet-clear-all]").forEach(s=>{s.addEventListener("click",this.boundHandlers.onActiveFilterClick)}));const n=this.querySelector("[data-facets-open]");if(n){const s=t.querySelector("[data-facets-open]");s&&n.replaceChildren(...s.cloneNode(!0).childNodes)}}updateProductCount(t){const e=t.querySelector("#ProductCount"),i=this.querySelector("#ProductCount");e&&i&&i.replaceChildren(...e.cloneNode(!0).childNodes)}updatePagination(t){const e=t.querySelector("[data-pagination-load-more]"),i=document.querySelector("[data-pagination-load-more]");i&&(e?i.replaceChildren(...e.cloneNode(!0).childNodes):i.replaceChildren());const n=t.querySelector(".collection-wrapper nav"),s=document.querySelector(".collection-wrapper nav");s&&n?s.replaceChildren(...n.cloneNode(!0).childNodes):s&&!n&&s.remove()}updateURL(t){const e=new URLSearchParams(t);e.delete("section_id");const i=e.toString(),n=i?`${window.location.pathname}?${i}`:window.location.pathname;history.pushState({searchParams:i},"",n)}showLoading(){this.loading&&(this.loading.style.opacity="1",this.loading.style.pointerEvents="auto")}hideLoading(){this.loading&&(this.loading.style.opacity="0",this.loading.style.pointerEvents="none")}}customElements.get("facet-filters-form")||customElements.define("facet-filters-form",S);l.registerPlugin(f,I,T);window.gsap=l;window.Flip=I;window.SplitText=T;window.Lenis=H;function L(){C.init()}function O(){window._articleProgressCleanup&&(window._articleProgressCleanup(),window._articleProgressCleanup=null);const d=document.getElementById("article-progress"),t=document.getElementById("article-progress-bar"),e=document.querySelector("[data-article-wrapper]");if(!d||!t)return;if(!e){d.style.display="none",t.style.width="0%";return}d.style.display="block",t.style.width="0%";let i=!1;function n(){return window.pieces&&window.pieces.lenis&&window.pieces.lenis.lenis?window.pieces.lenis.lenis.scroll:window.scrollY}function s(){if(i)return;const h=n(),y=e.getBoundingClientRect(),w=h+y.top,v=e.offsetHeight,m=window.innerHeight,q=w,_=w+v-m,x=h;let k=0;x>=q&&x<=_?k=(x-q)/(_-q)*100:x>_&&(k=100),t.style.width=`${Math.min(100,Math.max(0,k))}%`}let r=null;function a(){if(window.pieces&&window.pieces.lenis&&window.pieces.lenis.lenis){const h=window.pieces.lenis.lenis;return r=()=>s(),h.on("scroll",r),!0}return!1}if(!a()){let w=function(){if(!i){if(a()){s();return}h++,h<y&&setTimeout(w,100)}},h=0;const y=50;w()}let o=!1;function c(){o||(requestAnimationFrame(()=>{s(),o=!1}),o=!0)}window.addEventListener("scroll",c,{passive:!0}),s();function p(){i=!0,window.removeEventListener("scroll",c),r&&window.pieces&&window.pieces.lenis&&window.pieces.lenis.lenis&&window.pieces.lenis.lenis.off("scroll",r),d&&(d.style.display="none"),t&&(t.style.width="0%")}window._articleProgressCleanup=p}function et(){const d=()=>{requestAnimationFrame(()=>{typeof window.shouldAnimate=="function"&&window.shouldAnimate()&&(C.reinit(),L(),f.refresh()),E.reinit(),$.reinit()})};document.fonts&&document.fonts.ready?document.fonts.ready.then(d):d()}function it(){setTimeout(()=>{O()},100)}function nt(){document.addEventListener("menu:open",()=>{g.stop()}),document.addEventListener("menu:close",()=>{g.start()})}function M(){const d=window.matchMedia("(prefers-reduced-motion: reduce)").matches,t=window.themeSettings?.enableSmoothScroll!==!1;!d&&t&&g.init();const e=window.themeSettings?.enablePageTransitions!==!1;!d&&e&&(P.init(),window.addEventListener("swup:contentReplaced",et),window.addEventListener("swup:transitionEnd",it));const i=window.themeSettings?.enableAnimations!==!1;!d&&i&&(document.fonts&&document.fonts.ready?document.fonts.ready.then(()=>{requestAnimationFrame(()=>{L(),f.refresh()})}):requestAnimationFrame(()=>{L()})),requestAnimationFrame(()=>{O()}),nt(),u.init(),u.subscribe(n=>{n&&document.querySelectorAll("[data-cart-count]").forEach(s=>{s.textContent=n.item_count,n.item_count>0?s.removeAttribute("hidden"):s.setAttribute("hidden","")})}),E.init(),$.init(),document.addEventListener("cart:updated",()=>{P.clearCache("/cart")}),document.addEventListener("cart:refresh",()=>{u.fetch()}),document.addEventListener("click",n=>{const s=n.target.closest('a[href^="#"]');if(s&&s.getAttribute("href").length>1){n.preventDefault();const r=document.querySelector(s.getAttribute("href"));r&&g.scrollTo(r,{offset:-100})}}),window.pieces={lenis:g,swup:P,tween:C,cartState:u,cartDrawer:E,cartPage:$,gsap:l,ScrollTrigger:f,Flip:I,SplitText:T,Lenis:H},window.openCartDrawer=()=>E.open(),window.closeCartDrawer=()=>E.close(),window.refreshCartDrawer=()=>E.refresh()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",M):M();window.Shopify&&window.Shopify.designMode&&(document.addEventListener("shopify:section:load",()=>{typeof window.shouldAnimate=="function"&&window.shouldAnimate()&&(C.reinit(),L())}),document.addEventListener("shopify:section:unload",()=>{C.destroy()}),document.addEventListener("shopify:section:reorder",()=>{typeof window.shouldAnimate=="function"&&window.shouldAnimate()&&C.refresh()}));
